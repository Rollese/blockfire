...
const RAMP_REACH_EPS := 0.6     # m; ramps need a larger catch = max per-tick climb at sprint (LIGHT armor 1.2x → ~11.5 m/s * dt on a 1:1 slope ~0.38) + margin (M18 widened LIGHT 1.0→1.2; margin 0.6-0.38≈0.22, revisit before further speed tuning)
