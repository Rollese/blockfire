...
- **Engineer vehicle repair kit** (defined in M4.5, wired here): Engineer hold-action near a vehicle restores vehicle HP at `REPAIR_RATE` per tick; server-authoritative, consumes repair charges.
