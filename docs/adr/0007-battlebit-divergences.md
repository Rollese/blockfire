...
- **Layered counterplay.** Spawning is **disabled while an enemy is within the FOB's vicinity radius** (the FOB persists), and the bunker is **destructible** via the existing M4 destruction path (weapons/explosives) — enemy AI hunts it as a normal structure. Suppress to disable; destroy to remove.
