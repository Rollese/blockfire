...
| M11 | [Destructible buildings](milestones/M11-destructible-buildings.md) | **P1 done** (sim unify) | BattleBit-style destructible map buildings on the M4 substrate. **P1 chunked-store unify merged 2026-06-18** (unit suite green; no-regression vs master). **Split gate:** sim 128-bot headless (chunks destroyed + cascade + collapse + replicate + budget + winner; **+ M4 re-gate**), feel owner-playtest (holes/debris/collapse). Cascade/collapse (P2), authoring/art (P3), client cosmetics (P4, **needs M7**). Coordinates with M5.5-P3 (melee). Spec ratified 2026-06-18. |
