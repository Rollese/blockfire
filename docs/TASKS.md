...
| M5.5 | [Combat Depth II (ballistics/loadout/suppression/melee/throwables)](milestones/M5.5-combat-depth-2.md) | **P1 done ✅** | **P1 (ballistics/fire-mode/secondary) CLOSED 2026-06-23** — fleet gate PASS on game2 (`peak tick=24.71ms<33.3`, proj=207 projhit=19 swaps=32, winner=0; `docker/srvlog-20260623-124223.log`); 672 unit tests green; mechanic proven deterministically (`tests/projectile_gate_test.gd`). P2 armor TTK + suppression delta; P3 melee/back-stab/sledge/flash/impact still todo. **Ballistics (P1) feeds M7-C2 prediction** (owner-directed 2026-06-17). |
