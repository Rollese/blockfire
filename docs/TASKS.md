...
| M3 | [Conquest + respawn + squads](milestones/M3-conquest-squads.md) | **gameplay ✅ · 128-perf blocked (hw)** | Bot-only Conquest match runs start→win. Gate 2026-06-15: gameplay PASS at 128 (`winner=0 elapsed=217s cap_events=2`, ended via tickets); full gate PASS at 48 (tick 19.7ms<33.3). 128-bot tick budget FAILS on this laptop (106ms, thermal throttle — M2 also fails on this box today); needs separate-host fleet. 88 unit tests green. See milestone doc. |
