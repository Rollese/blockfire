...
| M4 | [Building & destruction](milestones/M4-building-destruction.md) | in-progress | Phase 1 (Building) gate PASS 2026-06-15 (laptop-48 + fleet-128, peak tick 30.89ms<33.3) — Phase 2 (Destruction) next. Building/destruction under 128-bot load holds tick + bandwidth budget. |
