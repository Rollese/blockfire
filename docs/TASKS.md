...
| M11 | [Destructible buildings](milestones/M11-destructible-buildings.md) | **P1+P2+P3 impl done** (sim); Gate A pending | BattleBit-style destructible map buildings on the M4 substrate. **P1 chunked-store unify + P2 support cascade/collapse + P3 building catalog/prefabs/art all merged to master 2026-06-18** (`shared/sim/support.gd`, `COLLAPSE` msg, `building_id` store, `buildings/*.json`, server cascade/collapse wiring; unit + deterministic functional tests green). **Outstanding: Gate A (128-bot sim fleet)** — was deferred while combat AI was inert; **now unblocked (AI fires as of 2026-06-23, see M5.5-P1/P2 gates)**. **P4 client cosmetics needs M7.** Coordinates with M5.5-P3 (melee). Spec ratified 2026-06-18. |
