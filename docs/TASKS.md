...
| M11 follow-up — dense-map snapshot cost | — | todo | Buildings-dense maps exceed the 128p tick budget (showcase 2463 pc / town 8324 pc); proving_grounds (177) + arena_buildings (768) hold it. Snapshot-cost optimisation if rich maps wanted at 128p. |
