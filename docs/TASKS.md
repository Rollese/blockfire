...
| M5.5 | [Combat Depth II (ballistics/loadout/suppression/melee/throwables)](milestones/M5.5-combat-depth-2.md) | **P1+P2 done ✅** | **P1 (ballistics/fire-mode/secondary) CLOSED 2026-06-23** — fleet gate PASS (`peak tick=24.71ms`, proj=207 swaps=32; `docker/srvlog-20260623-124223.log`). **P2 (armor class + suppression) CLOSED 2026-06-23** — fleet gate PASS on game2 (`winner=0 elapsed=307s<600 cap_events=4 peak tick=26.91ms<33.3 supp=1323 agg=15.6Mbit/s`; `docker/srvlog-p2fleet-20260623-155605.log`); 691 unit tests green; mechanics proven deterministically (`tests/armor_test.gd`, `tests/suppress_test.gd`, `tests/projectile_gate_test.gd`). **P3 melee/back-stab/sledge/flash/impact still todo.** **Ballistics (P1) feeds M7-C2 prediction** (owner-directed 2026-06-17). |
