...
## Next
Consult **[`docs/TASKS.md`](TASKS.md)** — currently: M7 human-playtest gate, M7.5 P3/P4, M6 wiring after M7, and the remaining deep-review batches (`docs/reviews/2026-07-02-deep-codebase-investigation.md` §"Suggested execution order"). M8-P3 config + map rotation landed 2026-07-03. Longer-horizon perf/destruction work is prioritized in `docs/reviews/2026-07-03-fable-goals-architecture-review.md` §E.
